...
PIDController pidBallX(0.7f, 0.0f, 0.05f, 0, 0.0f);
PIDController pidBallY(0.7f, 0.0f, 0.05f, 0, 0.0f);
...
PIDController pidCenterX(4.0f, 0.0f, 0.3f, 0, 0.0f);
PIDController pidCenterY(4.0f, 0.0f, 0.3f, 0, 0.0f);
